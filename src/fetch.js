export default [
    ...
    },
    {
      ...
      price: "$89.99",
      description:
        "No two coffee drinkers are the same – so, the flexibility.",
      avatarUrl:
    ...
    },
    {
      ...
      price: "$36.48",
      description:
        "3-layered Stainless steel filter traps the smallest coffee.",
      avatarUrl:
    ...
    },
    {
      ...
      price: "$32.95",
      description:
        "We use double stainless steel screen filters.",
      avatarUrl:
    ...
    },
    {
      ...
      price: "$37.99",
      description:
        'Brew with a single serve k-cup pod or ground coffee.',
      avatarUrl:
